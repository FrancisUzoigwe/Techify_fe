import coding from "../../assets/serious.jpg"
...
const ThirdSection = () => {
    ...
    return (
        <div className=" w-full min-h-[100vh] flex justify-center  items-center ">
            <div className="w-[95%] h-auto  flex justify-between max-lg:flex-col-reverse">

                <div className="h-[500px] md:mt-20 max-lg:w-[95%]  w-[630px]  rounded-3xl max-md:mt-24">
                ...
                <Fade direction="up" triggerOnce={true} delay={700}>
                    <div className="h-[400px] md:ml-5  max-lg:w-[95%]  w-[550px] max-xl:w-[450px] rounded-3xl relative" style={{ background: `url(${coding})`, backgroundPosition: "top", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                        <div className="w-[200px] h-[200px] rounded-lg  absolute -bottom-16 -left-4" style={{ background: `url(${coding1})`, backgroundSize: "cover", backgroundPosition: "center" }}></div>
                    </div>
                </Fade>
            </div>
        </div>
