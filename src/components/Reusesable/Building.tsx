                    ...
                    <div className="h-[400px]  max-lg:h-[450px] w-full relative">
                        <div className="grid grid-cols-2 gap-5 relative inset-0">
                            <Fade direction="up" delay={600} triggerOnce={true}>
                                <img src={me} className="mt-5 h-[250px] object-cover rounded-2xl col-span-1 row-span-1 bg-center" />
                            </Fade>
                            <Fade direction="down" delay={800} triggerOnce={true}>
                                <img src={me1} className="mt-48 h-[250px]  object-cover bg-center bg-[black] rounded-2xl col-span-1 row-span-1 self-end " />
                            </Fade>
                        </div>
                    </div>
